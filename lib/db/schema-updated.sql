...
INSERT INTO settings (key, value) VALUES
  ...
  ('contact_meta_title', '"Contact | Habib Farooq"'),
  ('contact_meta_description', '"Get in touch with Habib Farooq for project inquiries, collaborations, or just to say hello."'),
  ('projects_meta_title', '"Projects | Habib Farooq"'),
  ('projects_meta_description', '"Explore my portfolio of web applications, mobile apps, and technical projects."'),
  ('blog_meta_title', '"Blog | Habib Farooq"'),
  ('blog_meta_description', '"Read my thoughts on web development, programming, and technology."'),
