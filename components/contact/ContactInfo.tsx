...
import { Mail, Clock, Calendar, MessageSquare, Code, MapPin, ChevronRight } from 'lucide-react'
    ...
    >
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-black tracking-tight uppercase">Contact <span className="text-primary">Details</span></h2>
        </div>
        ...
        <div className="space-y-4">
          ...
          return (
            ...
            >
              ...
              <div className={`p-3.5 rounded-xl ${method.iconBg} ${method.iconColor} ring-1 ring-inset ring-white/10`}>
              ...
              <div className="flex-1">
                ...
                <p className="text-primary font-medium hover:underline decoration-2 underline-offset-4">{method.value}</p>
      ...
      >
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-lg font-bold tracking-tight uppercase">Core <span className="text-teal-600">Expertise</span></h3>
        </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-0.5">Let's discuss your project requirements</p>
            </div>
          </div>
          <Button
