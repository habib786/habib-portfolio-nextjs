                    ...
                    "&:hover": {
                      bgcolor:
                        activeSection === item.id
                          ...
                          : "rgba(16,106,90,0.06)",
                      color:
                        activeSection === item.id ? "white" : "var(--primary)",
                    },
                  }}
                >
                  {item.title}
      ...
      >
        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <Stack spacing={2}>
              {(relatedPosts?.length ? relatedPosts : fallbackRelatedPosts).map(
                (relatedPost) => (
                  <Box
                    key={relatedPost.id}
                    component={Link}
      ...
      >
        <Card
          sx={{
            borderRadius: "5px",
            background:
              "linear-gradient(135deg, var(--primary) 0%, #0d594b 100%)",
            color: "white",
