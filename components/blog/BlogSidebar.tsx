        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              ...
              experiences about web development, AI, and modern technology.
            </Typography>
                ...
                >
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                    ...
                    <Typography
                      variant="body2"
                      className="cat-name"
                      sx={{ fontWeight: 500, transition: "color 0.2s" }}
                    >
                      {category.name}
                    </Typography>
                  </Box>
        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <Typography variant="body2" sx={{ mb: 3, opacity: 0.9 }}>
              Subscribe to get notified about new articles, tutorials, and
              exclusive content.
            </Typography>
