...
const defaultBlogPosts = [
  {
    ...
    featuredImage: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&auto=format&fit=crop&q=60',
    author: 'Habib Farooq',
  ...
  },
  {
    ...
    content: 'Full content here...',
    featuredImage: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?w=800&auto=format&fit=crop&q=60',
    author: 'Habib Farooq',
  ...
  },
  {
    ...
    content: 'Full content here...',
    featuredImage: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800&auto=format&fit=crop&q=60',
    author: 'Habib Farooq',
  ...
  },
  {
    ...
    excerpt: 'A practical guide to implementing real-time features using WebSockets in modern web applications.',
    content: 'Full content here...',
    featuredImage: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&auto=format&fit=crop&q=60',
    author: 'Habib Farooq',
...
export default function BlogGrid() {
    ...
    async function loadPosts() {
      try {
        ...
        const mapped = data.map((post: any) => ({
          ...
          featuredImage: post.cover_image || 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&auto=format&fit=crop&q=60',
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 2 }}>
          ...
          <Select
            ...
            sx={{
              ...
              '& .lucide': { mr: 1, ml: 1, width: 16, height: 16, color: 'text.secondary' }
            }}
          >
      ...
      {/* Results Info */}
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', color: 'text.secondary', typography: 'body2' }}>
        <Typography variant="body2">
          Showing {filteredPosts.length > 0 ? startIndex + 1 : 0}-{Math.min(startIndex + postsPerPage, filteredPosts.length)} of {filteredPosts.length} articles
        </Typography>
        {searchQuery && (
          <Typography variant="body2">
            Search results for: <Box component="span" sx={{ fontWeight: 600 }}>"{searchQuery}"</Box>
          </Typography>
        )}
      </Box>
              ...
              >
                <Box sx={{ position: 'relative', height: 240, p: 1.5 }}>
                  ...
                  >
                    ...
                    >
                      <Stack direction="row" spacing={2.5} sx={{ color: 'white' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                          <Eye size={14} />
                          <Typography variant="caption" sx={{ fontWeight: 700 }}>{post.views.toLocaleString()}</Typography>
                        </Box>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                          <Clock size={14} />
                          <Typography variant="caption" sx={{ fontWeight: 700 }}>{post.readTime}m</Typography>
                        </Box>
                      </Stack>
                    </Box>
                  </Box>
                ...
                <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', p: 3, pt: 1 }}>
                  ...
                  <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between', mb: 3 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, color: 'text.secondary' }}>
                      ...
                      <Typography variant="caption" sx={{ fontWeight: 700 }}>{post.author}</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, color: 'text.secondary', opacity: 0.6 }}>
                      <Calendar size={12} />
      ...
      {filteredPosts.length === 0 && (
        <Box sx={{ textAlign: 'center', py: 8 }}>
          ...
          <Typography variant="h5" sx={{ fontWeight: 'bold', mb: 1 }}>No articles found</Typography>
