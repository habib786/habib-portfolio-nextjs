    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 1 }}>
        <motion.div style={{ y: yContent, opacity: opacityFade }}>
          ...
          <Typography variant="h1" sx={{ fontWeight: 800, mb: 2, fontSize: { xs: '2.5rem', md: '4rem' }, maxWidth: 900 }}>
            {project.title}
          </Typography>

          <Typography variant="h5" sx={{ mb: 4, fontWeight: 400, opacity: 0.9, maxWidth: 800 }}>
            {project.excerpt}
          </Typography>
