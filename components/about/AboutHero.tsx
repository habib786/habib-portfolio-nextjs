...
export default function AboutHero({ profileImage }: { profileImage: string }) {
  ...
  return (
    ...
    >
      {/* ── Soft glow blobs ── */}
      <Box sx={{
        position: 'absolute', top: '5%', right: '8%', width: 340, height: 340,
        bgcolor: '#FACC15', filter: 'blur(160px)', opacity: 0.07,
        borderRadius: '50%', pointerEvents: 'none', zIndex: 0,
      }} />
      <Box sx={{
        position: 'absolute', bottom: '-5%', left: '3%', width: 260, height: 260,
        bgcolor: '#FACC15', filter: 'blur(120px)', opacity: 0.05,
        borderRadius: '50%', pointerEvents: 'none', zIndex: 0,
      }} />
      ...
      >
        <svg width="100%" height="200" viewBox="0 0 1440 200" fill="none"
          ...
          style={{ opacity: 0.12 }}>
          <path d="M0 50C150 100 300 0 450 50C600 100 750 0 900 50C1050 100 1200 0 1350 50C1500 100 1650 0 1800 50"
            stroke="white" strokeWidth="2" />
          <path d="M0 100C150 150 300 50 450 100C600 150 750 50 900 100C1050 150 1200 50 1350 100C1500 150 1650 50 1800 100"
            stroke="white" strokeWidth="2" />
          <path d="M0 150C150 200 300 100 450 150C600 200 750 100 900 150C1050 200 1200 100 1350 150C1500 200 1650 100 1800 150"
            stroke="white" strokeWidth="2" />
        </svg>
      </motion.div>
          ...
          <motion.div style={{ y: yTitle, opacity: opTitle }}>
            ...
            >
              <Typography
                variant="body1"
                sx={{
                  mt: 3, color: 'rgba(255,255,255,0.65)',
                  fontWeight: 500, maxWidth: 340,
                  lineHeight: 1.75, letterSpacing: 0.4,
                }}
              >
                Full Stack Developer · <Counter value="7+" /> Years · Building the future, one line of code at a time.
              </Typography>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
               transition={{ duration: 1, delay: 0.2, ease: [0.34, 1.56, 0.64, 1] as [number, number, number, number] }}
            >
