...
export const timelineData: TimelineEvent[] = [
  ...
  },
  {
    ...
    date: "2024-PRESENT",
    description:
      "Architecting high-performance web applications and contributing to the global developer community. Focusing on scalable infrastructure and premium UX/UI designs.",
    icon: Briefcase,
  },
];
    ...
    >
      ...
      <Box
        sx={{
          ...
          ms: { xs: "70px", md: isAlternate ? 0 : "auto" },
          me: { xs: 0, md: isAlternate ? "auto" : 0 },
        }}
      >
        <motion.div
          style={{ y: yOffset }}
      ...
      >
        ...
        >
          ...
          >
            {event.icon && <event.icon size={isMobile ? 16 : 22} />}
          </Box>
        </motion.div>
...
export default function ExperienceTimeline({
  ...
  if (!mounted) {
    return <Box ref={containerRef} sx={{ minHeight: 400 }} />;
  }
      ...
      <Box sx={{ maxWidth: "1200px", mx: "auto", px: 2 }}>
        ...
        <Box sx={{ position: "relative", minHeight: "400px" }}>
          ...
          <Box
            sx={{
              position: "absolute",
              insetInlineStart: { xs: "20px", md: "50%" },
              ...
              "&::before": {
                ...
                height: "100%",
                background:
                  "linear-gradient(to bottom, transparent, rgba(16, 106, 90, 0.5) 20%, rgba(16, 106, 90, 0.5) 80%, transparent)",
              },
            }}
          />
          ...
          {displayData.map((event, index) => {
            ...
            const icon =
              event.icon ||
              (event.type === "education" ? GraduationCap : Briefcase);
