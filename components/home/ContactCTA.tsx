    ...
    >
      ...
      <Box
        sx={{
          ...
          height: "100%",
          background:
            "linear-gradient(135deg, rgba(16, 106, 90, 0.05) 0%, rgba(250, 204, 21, 0.05) 100%)",
          zIndex: 0,
        }}
      />
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        <Box sx={{ textAlign: "center", mb: 8 }}>
          ...
          >
            Have a project in mind? Looking for a developer? Feel free to reach
        ...
        <Grid container spacing={8}>
          ...
          <Grid size={{ xs: 12, lg: 5 }}>
            <Stack spacing={4}>
              ...
              <Paper
                variant="outlined"
                sx={{ p: 4, borderRadius: 1, bgcolor: "transparent" }}
              >
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Button
                    ...
                    component={Link}
                    href={getLocalizedHref("/schedule", pathname)}
                  >
                    Schedule a Call
                  </Button>
                </CardContent>
