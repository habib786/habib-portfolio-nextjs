...
function mapPost(raw: RawBlogPost | null): MappedBlogPost {
  ...
  const publishedAt =
    raw.published_at || raw.created_at || new Date().toISOString();
  ...
  return {
    ...
    featuredImage:
      (raw.cover_image as string) ?? (raw.featuredImage as string) ?? "",
...
export async function generateMetadata({
  ...
  const ogImageUrl = post.featuredImage || "/opengraph-image";
